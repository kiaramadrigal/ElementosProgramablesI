...
float R1 = 10;                                               // Valor de R1 de la PCB 10k
...
R2 = R1 * (1 / (float)valor - 1.0);                      //Calculo de la resistencia del termistor
...
Serial.println(R2);                                          //Impresión de temperatura en Celsius
...
if (R2 >= -10.72) {                                               //Si la temperatura es por arriba de 22° 
